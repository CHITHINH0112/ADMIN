...
class OrderItemModel
{
    ...
    {
        // 1. Kiểm tra dữ liệu đầu vào (Debug)
        if (empty($order_id) || empty($product_variant_id)) {
            return false;
        }
        ...
        // 3. Thực thi (Lưu ý thứ tự tham số)
        return $stmt->execute([$order_id, $product_variant_id, $quantity, $price]);
    }

    // Thêm hàm lấy items để hiển thị ở OrderSummary
